...
import 'package:futsol_mania/Models/Slot.dart';
import 'package:futsol_mania/Pages/HomeScreen.dart';
import 'package:futsol_mania/main.dart';
...
import 'package:futsol_mania/utils/styles.dart';
...
class _UserHomeFragmentState extends State<UserHomeFragment> {
  DatabaseReference grouds = FirebaseDatabase.instance.reference().child("grounds");
  String logo1;
  String logo2;
  var _index = 1;
              ...
              if(slotss.value!=null)
                {
                  for (var slotsData in slotss.value.keys) {
                    grouds.child(key).child("Slots").child(slotsData).once().then((DataSnapshot finalData)
                        {
                          if(finalData.value!=null)
                            {
                              for (var slotsDatakeys in finalData.value.keys) {
                                var finalDataValues = finalData.value;
                                if(finalDataValues[slotsDatakeys]['status']=="Booked") {
                                  setState(() {
                                    Slot d = new Slot(
                ...
                Expanded(
                  ...
                  child: Container(
                    ...
                    child: CircleAvatar(
                        ...
                        radius: 40.0,
                        child: ClipOval(
                            child: (slots[i].team1_logo != "" || slots[i].team1_logo!=null)
                                ? Image.network(
                              slots[i].team1_logo,
                              width: 72,
                              height: 70,
                ...
                Expanded(
                  ...
                  child: Container(padding: EdgeInsets.all(2.0),
                    child: CircleAvatar(
                        ...
                        radius: 40.0,
                        child: ClipOval(
                            child: (slots[i].team2_logo != "" || slots[i].team2_logo!=null)
                                ? Image.network(
                              slots[i].team2_logo,
                              width: 72,
                              height: 70,
